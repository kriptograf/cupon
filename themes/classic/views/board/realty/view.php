    ...
    <div class="wrapper-inner">
        ...
        <div class="equal">
            <div class="main">
                ...
                <div id="form-title" class="title-section realty">
                ...
                <div class="spacer-view">
                    <a id="back" href="/board/realty/category/id/<?php echo $model->category_id;?>">К списку</a>
                ...
                <div id="left">
                    <div id="title">
                        ...
                        <strong><?php echo $model->address;?></strong><br>

                        <p class="view-area">
                            Площадь: <?php echo $model->area;?> м<sup>2</sup>
                        </p>
                        <?php if($model->rooms):?>
                        <p class="view-rooms">
                            Количество комнат: <?php echo $model->rooms;?>
                        </p>
                        <?php endif;?>
                        <span class="title-price"><?php echo ($model->price)?'<b>'.$model->price.'</b> руб.':'Цена не указана';?></span>
                    </div>
                    <div id="contacts">
...
<script>
    $(document).ready(function(){
        ...
        $('#print').click(function(event){
            event.preventDefault();
            var url = '/board/realty/print/id/<?php echo $model->id;?>';
...
$form = $this->beginWidget('CActiveForm', array(
    ...
    'action' => array('/board/realty/complain'),
));
?>
...
<?php echo $form->hiddenField($qForm,'item', array('value'=>'http://'.$_SERVER['HTTP_HOST'].'/board/realty/view/id/'.$model->id)); ?>
