...
class AdsField extends CActiveRecord
{
	const VISIBLE_ALL=3;
	...
	{
		return Yii::app()->getModule('board')->tableAdsFields;
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('varname', 'match', 'pattern' => '/^[A-Za-z_0-9]+$/u','message' => BoardModule::t("Variable name may consist of A-z, 0-9, underscores, begin with a letter.")),
			array('varname', 'unique', 'message' => BoardModule::t("This field already exists.")),
	...
	public function attributeLabels()
	{
		return array(
			'id' => BoardModule::t('Id'),
			'varname' => BoardModule::t('Variable name'),
			'title' => BoardModule::t('Title'),
			'field_type' => BoardModule::t('Field Type'),
			'field_size' => BoardModule::t('Field Size'),
			'field_size_min' => BoardModule::t('Field Size min'),
			'required' => BoardModule::t('Required'),
			'match' => BoardModule::t('Match'),
			'range' => BoardModule::t('Range'),
			'error_message' => BoardModule::t('Error Message'),
			'other_validator' => BoardModule::t('Other Validator'),
			'default' => BoardModule::t('Default'),
			'widget' => BoardModule::t('Widget'),
			'widgetparams' => BoardModule::t('Widget parametrs'),
			'position' => BoardModule::t('Position'),
			'visible' => BoardModule::t('Visible'),
		);
	}
	...
	public static function itemAlias($type,$code=NULL) {
		$_items = array(
			'field_type' => array(
				'INTEGER' => BoardModule::t('INTEGER'),
				'VARCHAR' => BoardModule::t('VARCHAR'),
				'TEXT'=> BoardModule::t('TEXT'),
				'DATE'=> BoardModule::t('DATE'),
				'FLOAT'=> BoardModule::t('FLOAT'),
				'DECIMAL'=> BoardModule::t('DECIMAL'),
				'BOOL'=> BoardModule::t('BOOL'),
				'BLOB'=> BoardModule::t('BLOB'),
				'BINARY'=> BoardModule::t('BINARY'),
			),
			'required' => array(
				self::REQUIRED_NO => BoardModule::t('No'),
				self::REQUIRED_NO_SHOW_REG => BoardModule::t('No, but show on registration form'),
				self::REQUIRED_YES_SHOW_REG => BoardModule::t('Yes and show on registration form'),
				self::REQUIRED_YES_NOT_SHOW_REG => BoardModule::t('Yes'),
			),
			'visible' => array(
				self::VISIBLE_ALL => BoardModule::t('For all'),
				self::VISIBLE_REGISTER_USER => BoardModule::t('Registered users'),
				self::VISIBLE_ONLY_OWNER => BoardModule::t('Only owner'),
				self::VISIBLE_NO => BoardModule::t('Hidden'),
			),
		);
		if (isset($code))
