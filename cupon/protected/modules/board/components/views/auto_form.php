...
<div class="search-filter">
    <?php echo CHtml::beginForm('/board/auto/search','post');?>

    <div id="second-filter">
        <?php
        $arr = CHtml::listData(AutoTypes::model()->findAll(),'id','title')
        ...
        <?php echo CHtml::dropDownList('category', ($post['category'])?$post['category']:'' ,AutoCategory::getCategoriesForSelect(), array('empty'=>'Любое'));?>
