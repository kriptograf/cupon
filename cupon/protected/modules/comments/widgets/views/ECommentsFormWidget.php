<?php
        ...
        */
        ...
        <div class="form">
            ...
            <!--<div style="float: left;">Примите участие в голосовании, сделайте рейтинг объективным<br />-->
        <?php
        /*$this->widget('CStarRating',array(
            ...
            'allowEmpty' => false,
            'readOnly' => (Yii::app()->request->cookies['company_'.$newComment->owner_id]->value)?true:false,//Yii::app()->user->isGuest || ,
            'value'=> $rating,
            'callback'=>'function(){
                                                            $.ajax({
                                                                type: "POST",
                                                                url: "'.Yii::app()->createUrl('companies/rating').'",
                                                                data: "id='.$newComment->owner_id.'&rate=" + $(this).val(),
                                                                dataType : "json",
