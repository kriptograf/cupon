...
class Comment extends CActiveRecord
{
    ...
    public function relations()
    {
        $relations = array(
            ...
            'company' => array(self::BELONGS_TO, 'Companies', 'owner_id'),
        );
    ...
    public function attributeLabels()
    {
        return array(
            ...
            'owner_id' => 'Компания',//Yii::t('CommentsModule.msg', 'Commented object\'s ID'),
            /* 'comment_id' => 'Comment',
            ...
            'status' => 'Публикация',//Yii::t('CommentsModule.msg', 'Status'),
    ...
    public function getCommentsTree()
    {
        ...
        $criteria->compare('t.status', '<>' . self::STATUS_NOT_APPROVED);
