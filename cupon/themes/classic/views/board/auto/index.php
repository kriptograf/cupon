        ...
        <div class="equal">
            <div class="main">
                ...
                <div id="form-title" class="title-section realty">
                    <h1 class="section-h1">Авто</h1>

                    <span class="add-board">
                        <a href="/board/auto/create">Добавить объявление</a>
                    </span>
                    <span class="count-board">Объявлений <?php echo $dataProvider->totalItemCount;?></span>
                </div>

                <!-- filter-->
                <?php $this->widget('AutoFilterWidget');?>

                <!-- список категорий -->
                <h2 class="board-cat-title">Категории</h2>
                <ul class="cat-menu">
                    <?php foreach($categories as $cat):?>
                        <?php if($cat->countAuto):?>
                            <li><a href="<?php echo Yii::app()->createUrl('/board/auto/category/id/'.$cat->id);?>"><?php echo $cat->name;?> </a><span class="count-ads"><?php echo $cat->countAuto;?></span></li>
                        <?php endif;?>
                    <?php endforeach;?>
                </ul>
