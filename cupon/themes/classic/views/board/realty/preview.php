            ...
            <div class="main">
                ...
                <div id="left">
                    <div id="title">
                        <strong>
                            <script>
                                document.write(window.opener.document.getElementById('Realty_title').value);
                            </script>
                        </strong><br>
                        <span>
                            <script>
                                if(window.opener.document.getElementById('Realty_price').value)
                                {
                                    document.write(window.opener.document.getElementById('Realty_price').value+' руб.');
                                }
                                else
                                {
                    ...
                    <div id="name">
                        <script>
                            document.write(window.opener.document.getElementById('Realty_author').value);
                        </script>
                    </div>
                    <div id="phone">
                        <script>
                            document.write(window.opener.document.getElementById('Realty_phone').value);
                        </script>
                    </div>
                    <div id="email">
                        <script>
                            document.write(window.opener.document.getElementById('Realty_email').value);
                        </script>
                    </div>
                ...
                <div id="right">
                    ...
                    <div id="details">
                        ...
                        <p id="detail-text">
                            <script>
                                document.write(window.opener.document.getElementById('Realty_details').value);
                            </script>
                        </p>
