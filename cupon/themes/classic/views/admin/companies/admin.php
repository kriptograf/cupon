...
<?php $this->widget('application.modules.admin.components.GridView', array(
	...
	'columns'=>array(
        ...
        array(
            'name'=>'category_id',
            'filter'=>CHtml::dropDownList('Companies[category_id]','',CHtml::listData(CategoriesCompany::model()->findAll('parent_id IS NOT NULL'),'id','name'),array('empty'=>'-Подкатегория-')),
        ...
        array(
            ...
            (
                ...
                (
                    ...
                    'url'=>'Yii::app()->createUrl("admin/companies/update/", array("id"=>$data->id,"returnPage"=>Yii::app()->request->getQuery("Companies_page", 1)))',
                ),
            ),
        ),
        array(
