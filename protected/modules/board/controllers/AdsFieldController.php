...
class AdsFieldController extends Controller
{
	...
	public function registerScript() {
		...
		$wgByTypes = AdsField::itemAlias('field_type');
	...
	var fieldType = {
			...
			'BOOL':{
				...
				'val':{
					'field_size':0,
					'default':0,
					'range':'1==".BoardModule::t('Yes').";0==".UserModule::t('No')."',
					'widgetparams':''
				}
			},
			'BLOB':{
	...
	function showWidgetList(type) {
		...
		$('div.widget select').append('<option value=\"\">".BoardModule::t('No')."</option>');
		if (wgByType[type]) {
	...
	// show all function 
	$('div.form p.note').append('<br/><a href=\"#\" id=\"showAll\">".BoardModule::t('Show all')."</a>');
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['AdsField']))
		{
			$model->attributes=$_POST['AdsField'];
