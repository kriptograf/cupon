...
class NewsController extends Controller
{
	...
	public function accessRules()
	{
		return array(
			...
			array('allow', // allow admin user to perform 'admin' and 'delete' actions
				'actions'=>array('create','update','admin','delete','setTitle','setAlias','groupDelete','toggle'),
				'users'=>array('admin'),
			),
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['News']))
		{
            ...
            //echo CVarDumper::dump($_POST['News'],10,true);exit;
            ...
            {
                echo CVarDumper::dump($model->clearErrors(),10,true);exit;
            }
    ...
    public function actionGroupDelete()
    {
        if(isset($_POST))
        {
            ...
            if($items)
            {
                ...
                $criteria->addInCondition('id_news', $items);
